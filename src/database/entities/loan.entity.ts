...
export class LoanEntity {
  ...
  @Column({ name: 'principal_amount', type: 'decimal', precision: 14, scale: 2, transformer: decimalTransformer })
  principalAmount!: number;

  @Column({ name: 'suggested_installment_amount', type: 'decimal', precision: 14, scale: 2, nullable: true, transformer: decimalTransformer })
  suggestedInstallmentAmount!: number | null;

  @Column({ name: 'paid_amount', type: 'decimal', precision: 14, scale: 2, default: () => '0', transformer: decimalTransformer })
  paidAmount!: number;
